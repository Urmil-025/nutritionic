...
restService.post('/hook', function (req, res) {
    try {
        ...
        if (req.body) {
            ...
            httpGetAsync(requestBody.result.parameters.any).then(function(data) {
    ...
    try {
        ...
        if (req.body) {
            ...
            if(alexa_intent == '\"Search\"'){
                ...
                httpGetAsync(alexa_food_requested).then(function(data) {
                    ...
                    if(food_data.message === "Something went wrong"){
                        ...
                        var error_message_array = [
                            ...
                            'Sshh...we are now sleeping and dreaming about new features to implement. I\'ll be back shortly',
...
function httpGetAsync(search_query)
{
